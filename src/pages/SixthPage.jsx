...
export default function SixthPage() {
  return (
    <div className="w-full bg-[#f8f8f8] text-gray-900">
      {/* HERO */}
      <section
        className="relative h-[260px] md:h-[360px] lg:h-[420px] object-contain bg-cover bg-center"
      ...
      <section className="mx-auto mt-24 max-w-6xl px-6 pb-24">
        ...
        <div className="mt-10 flex justify-center">
          <button className="rounded-full bg-gray-100 hover:bg-black hover:text-white border px-8 py-3 text-sm">
            더보기 +
          </button>
        </div>
      </section>
