    ...
    <section className="min-h-screen bg-white px-4 sm:px-8 py-24">
         ...
         <div className="flex justify-center gap-8 mb-2 text-sm text-black font-bold flex-wrap">
            <nav className="lg:flex flex gap-8">
             <button className="border bg-black/80 rounded-full p-2">
               <Link to="/inquiry-modal" className="hover:text-white">
                투자대출
              </Link>
             </button>
      ...
      <div className="max-w-4xl mx-auto">
       ...
       {/* Filters */}
        ...
        <div className="flex justify-center items-center gap-6 mt-16 text-sm text-gray-400">
          ...
          <button className="hover:text-black">&rsaquo;</button>
          <button className="hover:text-black">&raquo;</button>
        </div>
      </div>
    </section>
  );
