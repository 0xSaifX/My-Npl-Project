...
export default function FourthPage() {
  ...
  return (
    <main className="bg-[#f7f7f7]">
      {/* Hero */}
      <section className="relative h-[260px] sm:h-[320px] lg:h-[380px] bg-cover
      "style={{
          backgroundImage:
      ...
      <div className="bg-white rounded-t-[32px] -mt-10 relative z-20">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-0 py-12">
          ...
          {/* GREEN CTA */}
          <section className="mt-12 bg-[#e6f3c8] rounded-2xl p-6 m-20 sm-40 flex items-center justify-between">
            <div>
