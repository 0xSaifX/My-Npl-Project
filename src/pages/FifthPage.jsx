...
>
    ...
    <h2 className="text-xl sm:text-2xl font-bold mb-2">변호사</h2>
    <p className="text-sm sm:text-base text-gray-600 mb-6">
      다양한 분야의 전문 변호사들이 여러분의 어려움을 해결해드립니다.
    </p>

    <div className="bg-blue-50 rounded-xl p-4 sm:p-6 mb-8 sm:mb-10">
      <span className="text-blue-600 font-semibold text-sm">이벤트</span>
      <p className="mt-1 font-bold">
        4월 한달간 변호사 수임료 50% 할인
      </p>
    </div>
    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6">
      {lawyers.map((lawyer, i) => (
        <div key={i} className="text-center">
          <div className="aspect-[2/4] overflow-hidden rounded-xl">
            <img
              src={lawyer.image}
              alt={lawyer.name}
              className="w-full h-full object-cover"
