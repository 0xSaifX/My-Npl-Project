...
function PartnersSection() {
  ...
  const partners = [
    ...
    { name: "비자", rating: "4.0", reviews: "14", contracts: "3", bg: "#", logo: visa }
  ];

  return (
    <section className="w-[1280px] mx-auto px-10 pt-40 pb-40">
      <div className="flex flex-col items-center gap-12">
        <div className="flex flex-col items-center gap-2 w-[1200px]">
          <div className="flex items-center gap-1">
...
function PopularPostsSection() {
  ...
  return (
    <section className="w-full bg-gray-100 py-[140px]">
    ...
    <section className="flex flex-col w-full p-20 max-w-[1280px] mx-auto px-10 pt-40 justify-center items-start gap-12">
      ...
      <div className="flex flex-col items-start gap-8 w-full">
        <div className="flex h-11 justify-center items-center gap-3 w-full">
          ...
          <div className="flex px-5 py-2.5 justify-center items-center gap-1 rounded-full bg-black/5">
            <div className="text-base font-bold font-pretendard text-gray-900">홍보</div>
          </div>
          <div className="flex px-5 py-2.5 justify-center items-center gap-1 rounded-full bg-black/5">
            <div className="text-base font-bold font-pretendard text-gray-900">이용방법</div>
          </div>
          <div className="flex px-5 py-2.5 justify-center items-center gap-1 rounded-full bg-black/5">
            <div className="text-base font-bold font-pretendard text-gray-900">카페/블로그/밴드</div>
          </div>
        </div>
