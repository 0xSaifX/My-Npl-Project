              ...
              {slides.map((slide, index) => (
                <div key={index} className="flex-[0_0_100%] min-w-0">
                  <img
                    src={slide.image}
                    alt={`Slide ${index + 1}`}
                    className="w-[800px] h-[400px] object-contain rounded-3xl"
                  />
                </div>
              ))}
            </div>
        ...
        <div className="flex flex-col gap-[92px] w-[520px] flex-shrink-0">
          <div className="flex flex-col gap-10">
            <div className="flex flex-col gap-3">
              <div className="text-[28px] leading-[150%] md:text-[20px] sm:text-[13px] lg:text-[24px] font-pretendard text-[#1C232C] whitespace-pre-line break-words">
