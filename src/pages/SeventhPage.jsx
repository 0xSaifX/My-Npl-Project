    ...
    <div className="w-full bg-[#FAFAFA] text-gray-900">
      ...
      <section className="w-full py-24 bg-white">
        <div className="max-w-[720px] mx-auto px-4 text-center">
          ...
          <div className="flex justify-center gap-3 mt-6 text-sm text-gray-500 flex-wrap">
            <span>#부동산</span>
            <span>#NPL</span>
            <span>#경매</span>
            <span>#투자</span>
      ...
      <section className="py-24">
        <div className="max-w-[1200px] mx-auto px-4">
          ...
          <button className="mx-auto mt-10 block px-6 py-2 border hover:text-black rounded-full text-sm">
            더보기 +
          </button>
        </div>
      </section>
      ...
      <section className="bg-[#5AA6D6] py-16">
        <div className="max-w-[1200px] mx-auto px-4 flex items-center justify-between flex-col md:flex-row gap-6">
